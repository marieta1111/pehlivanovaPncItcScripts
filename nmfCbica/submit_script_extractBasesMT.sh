...
#$ -o /cbica/home/pehlivam/CT/NMF/sge_job_output/extractBasesMT.$JOB_ID.stdout
#### save the standard error:
#$ -e /cbica/home/pehlivam/CT/NMF/sge_job_output/extractBasesMT.$JOB_ID.stderr
####
#### My email address:
#$ -M marieta@sas.upenn.edu
...
# file /cbica/home/pehlivam/CT/NMF/sge_job_output/extractBasesMT.$JOB_ID.stdout) and standard error (saved
# into the file /cbica/home/pehlivam/CT/NMF/sge_job_output/extractBasesMT.$JOB_ID.stderr) to make
...
/bin/echo "Command: /cbica/home/pehlivam/CT/NMF/scripts/extractBasesMT"
...
/bin/echo "Command: /cbica/home/pehlivam/CT/NMF/scripts/extractBasesMT" 1>&2
/bin/echo "Arguments: List of input files: $1 NumBases: $2 Output Directory: $3 mask: $4"
...
extractBasesMT=/cbica/home/pehlivam/CT/NMF/scripts/extractBasesMT
